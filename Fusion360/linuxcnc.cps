...
function onOpen() {
  ...
  // AMH - Setup path optimization
  writeBlock("G64 P0.010");
}
...
function onSection() {
  ...
  if (insertToolCall) {
    ...
    //AMH - 2018-12-10 - Probotix Comet does not like Tool Change
  ...
  if (insertToolCall || retracted || (!isFirstSection() && getPreviousSection().isMultiAxis())) {
    ...
    if (!machineConfiguration.isHeadConfiguration()) {
      ...
      // AMH - 2018-12-10 - Disabling G43 tool offset output
